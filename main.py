...
app = FastAPI(title='Backstract Generated APIs - coll-45b1eca87b974c489a67bb32b68bb321', debug=False,
              docs_url='/strange-cartwright-be8f8b16fe6611ef92110242ac12000534/docs',
              openapi_url='/strange-cartwright-be8f8b16fe6611ef92110242ac12000534/openapi.json')
...
app.include_router(
    router,
    prefix='/strange-cartwright-be8f8b16fe6611ef92110242ac12000534/api',
    tags=['APIs v1']
)
